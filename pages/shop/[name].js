...
import { Content, No_content } from "../../UI/ui";
   ...
   // console.log(items)
    ...
    <meta name="description" content={info_title[1]}></meta>
        ...
        <div className="container_info_shop_id">
            <div className="avatar_shop"><Image className="avatar_shop_image" src={items.image} width={100} height={100} style={{width: "100%", height:"auto"}}/></div>
...
export async function getServerSideProps({query}){
  ...
  //  console.log(page)
      const response = await fetch("https://kotedze.ru/server/shop/?name_url="+query.name)
